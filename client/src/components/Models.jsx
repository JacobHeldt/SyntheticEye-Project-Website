  ...
  return (
    ...
    <div className='font-poppins relative' id="models">
      ...
      <div 
        ...
        <div>
        A machine learning model that can detect faces generated by AI and can distinguish them from real faces.<br />
        <i className='text-gray-300 text-sm'>This model can be used <a href='/aletheia' className='underline'>here</a></i>
        </div>
        </div>
        </div>
        <div 
